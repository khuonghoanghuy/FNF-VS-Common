...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if (SONG == null)
			SONG = Song.loadFromJson('most-basic');
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'colim':
				...
				if (ClientPrefs.wiggleEna)
				{
					...
					wiggleShit.waveAmplitude = ClientPrefs.wiggleCurWaveAmplitude;
					wiggleShit.waveFrequency = ClientPrefs.wiggleWaveFrequency;
					wiggleShit.waveSpeed = ClientPrefs.wiggleWaveSpeed;
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 22, 0, "Common Engine v" + MainMenuState.commonEngine, 12);
